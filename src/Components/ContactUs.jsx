    ...
    <div className="bg-white">
      ...
      <div className='bg-[#F4ECE6] py-12 mb-10'
       style={{ backgroundImage: `url(${lines})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
        <div className="text-center m-auto prata-font mb-8 max-w-[350px] sm:max-w-[500px]">
        <div className="mb-5"> 
        <h1 className="mb-[-90px] font-bold text-center text-[100px] text-[#ffffff]">C</h1>
          <h1 className="text-4xl font-semi prata-font">Contact Us         
          </h1>
          </div>
      ...
      <div className="flex flex-col gap-10 md:gap-0 md:flex-row items-center m-auto mb-12 px-5 justify-between xl:max-w-[1200px] 2xl:max-w-[1500px]">
        ...
        <h1 className="mb-[-90px] text-[100px] text-[#f5ece6] prata-font">H</h1>
          <h2 className="text-4xl font-semibold mb-4 prata-font max-w-[300px]">Have A Question? Contact Us!</h2>
      ...
      lg:flex-row items-start bg-white pt-4 pb-0 px-0 mb-0"
          >
        ...
        <div className="w-full lg:w-1/2 h-full p-10 sm:p-12 lg:p-16 xl:p-24"
         style={{ backgroundImage: `url(${fromBg})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
          ...
          <form action="#" method="POST">
            ...
            <button 
              type="submit" 
              className="bg-[#375944] text-white px-8 py-3 prata-font text-[18px] rounded-md shadow-sm hover:bg-[#375944]/[90%] focus:outline-none focus:ring-none focus:border-0"
            >
              Submit
            </button>
          </form>
      ...
      style={{ backgroundImage: `url(${lines})`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
        <div className=" md:text-left flex flex-row gap-5">
            <spna className='h-[65px] w-[65px] bg-white place-content-center'>
      ...
      {/* FAQ Section */}
      <div className="bg-black/40 bg-blend-overlay bg-cover bg-center bg-no-repeat"
